        ...
        <div className="bg-white border border-outline-variant rounded-xl p-8 md:p-10 shadow-[0px_4px_20px_rgba(26,43,60,0.05)]">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-on-surface-variant">
              Start building your second brain with Principle Pitch.
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-semibold text-on-surface" htmlFor="confirm-password">
                Confirm Password
              </label>
              <input
                id="confirm-password"
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-on-surface-variant">
              ...
              <Link to="/signin" className="text-sm font-semibold text-secondary hover:underline underline-offset-4">
                Sign in
              </Link>
            </p>
          </div>
